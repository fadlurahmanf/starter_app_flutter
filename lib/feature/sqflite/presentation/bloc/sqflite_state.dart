...
class SqfliteState with _$SqfliteState {
  ...
  const factory SqfliteState.iFailed({required CustomException exception}) = _IFailed;
  ...
  const factory SqfliteState.gFailed({required CustomException exception}) = _GFailed;
  ...
  const factory SqfliteState.dFailed({required CustomException exception}) = _DFailed;
}
